...
def process_song_file(cur, filepath):
    ...
    artist_data = df[['artist_id','artist_name','artist_location','artist_latitude','artist_longitude']].drop_duplicates().values.tolist()[0]
...
def process_log_file(cur, filepath):
    ...
    column_labels = ('ts','hour','day','week','month','year','week_day')
